...
<div class="main-content">
	<body>
		<form class="form-labels-on-top" method="POST" enctype="multipart/form-data" action="updateevent.php">
			<div class="form-title-row">
                <h1>Form Pendaftaran Event</h1>
            </div>

            <div class="form-row">
            	<input type="text" name="event" value="<?php echo $event;?>" placeholder="Judul Event">	
            </div>
